...
<body>
    ...
    <?php
        if(isset($_GET['nip_doping'])){
            $sql3 = "SELECT * FROM dosen_pembimbing WHERE nip = '{$_GET['nip_doping']}'";
    ...
    <div class="w-full h-screen px-4 py-8 md:px-24 md:py-8">
        <div class="flex mb-20">
            ...
            <div class="lg:w-3/4 lg:pr-24">
                ...
                <h4 class="font-bold">Pencarian berdasarkan Dosen Pembimbing <?=$row3['nama_lengkap']?></h4>
                ...
                <div>
                    <ul class="space-y-4 text-green-700">
                        <?php
                            if(isset($_GET['nip_doping'])){
                                $sql1 = "SELECT * FROM tugas_akhir WHERE nip_dosen_pembimbing1 = '{$_GET['nip_doping']}' or nip_dosen_pembimbing2 = '{$_GET['nip_doping']}'";
