...
<body>
    ...
    <div class="w-full h-screen px-4 py-8 md:px-24 md:py-8">
                ...
                if(isset($_POST['save'])){
                    ...
                    if(strlen($nama_file) != 0){
                        ...
                        if(!in_array(pathinfo($nama_file,PATHINFO_EXTENSION),$allowed_extensions)){
                            ...
                            echo "<script type='text/javascript'> document.location = 'updatefile.php?type=$tipe'; </script>";
                        }else{
                        ...
                        if($tipe == 'tugas_akhir'){
                            ...
                            if($judul != $row5['judul']){ 
                                if($nip_doping1 == $row11['nip']|| $nip_doping2 == $row11['nip']){
                                    $sql1 = "UPDATE tugas_akhir SET judul = '$judul', nim_mhs = '$nim_mhs',tgl_pengesahan = '$tgl_pengesahan',nip_dosen_pembimbing1 = '$nip_doping1',nip_dosen_pembimbing2 = '$nip_doping2',nip_dosen_penguji1 = '$nip_dosen_penguji1',nip_dosen_penguji2 = '$nip_dosen_penguji2',id_kategori_repo = '$kategori_repo',abstract = '$abstract',id_keyword = '$keyword',file_link = '$nama_file',id_prodi = '$prodi' WHERE id = '{$_GET['id']}'";
                                }else{
                            ...
                            }elseif($judul == $row5['judul'] && $row5['id'] == $_GET['id']){
                                if($nip_doping1 == $row11['nip']|| $nip_doping2 == $row11['nip']){
                                    $sql1 = "UPDATE tugas_akhir SET judul = '$judul', nim_mhs = '$nim_mhs',tgl_pengesahan = '$tgl_pengesahan',nip_dosen_pembimbing1 = '$nip_doping1',nip_dosen_pembimbing2 = '$nip_doping2',nip_dosen_penguji1 = '$nip_dosen_penguji1',nip_dosen_penguji2 = '$nip_dosen_penguji2',id_kategori_repo = '$kategori_repo',abstract = '$abstract',id_keyword = '$keyword',file_link = '$nama_file',id_prodi = '$prodi' WHERE id = '{$_GET['id']}'";
                                }else{
                                    echo "<script> alert('NIP dosen pembimbing yang dimasukkan tidak memiliki nip user yang mengupload') </script>";
                                ...
                                echo "<script type='text/javascript'> document.location = 'updatefile.php?type=tugas_akhir&id={$_GET['id']}'; </script>";
                            }
                        }elseif($tipe == 'penelitian_dosen'){
                            ...
                            $row5 = mysqli_fetch_array($query5);
                            if($judul != $row5['judul']){
                                $sql1 = "UPDATE penelitian_dosen SET judul = '$judul', nama_anggota = '$nama_anggota',id_kategori_repo = '$kategori_repo',abstract = '$abstract', file_url = '$nama_file' WHERE id = '{$_GET['id']}'";
                            }elseif($judul == $row5['judul'] && $row5['id'] == $_GET['id']){
                                $sql1 = "UPDATE penelitian_dosen SET judul = '$judul', nama_anggota = '$nama_anggota',id_kategori_repo = '$kategori_repo',abstract = '$abstract', file_url = '$nama_file' WHERE id = '{$_GET['id']}'";
                            }else{
                                echo "<script> alert('Judul Sudah ada') </script>";
                                echo "<script type='text/javascript'> document.location = 'updatefile.php?type=penelitian_dosen&id={$_GET['id']}'; </script>";
                            }
                        }else{
                            $sql1 = "UPDATE ebook SET judul = '$judul',penulis = '$penulis',tgl_terbit = '$tgl_terbit',abstract = '$abstract', file_url = '$nama_file' WHERE id = '{$_GET['id']}'";
                        }
                    }
                    }else{
                        if($tipe == 'tugas_akhir'){
                            ...
                            if($judul != $row5['judul']){
                                if($nip_doping1 == $row11['nip']|| $nip_doping2 == $row11['nip']){
                                    $sql1 = "UPDATE tugas_akhir SET judul = '$judul', nim_mhs = '$nim_mhs',tgl_pengesahan = '$tgl_pengesahan',nip_dosen_pembimbing1 = '$nip_doping1',nip_dosen_pembimbing2 = '$nip_doping2',nip_dosen_penguji1 = '$nip_dosen_penguji1',nip_dosen_penguji2 = '$nip_dosen_penguji2',id_kategori_repo = '$kategori_repo',abstract = '$abstract',id_keyword = '$keyword',id_prodi = '$prodi' WHERE id = '{$_GET['id']}'";
                                }else{
                                    echo "<script> alert('NIP dosen pembimbing yang dimasukkan tidak memiliki nip user yang mengupload') </script>";
                                    echo "<script type='text/javascript'> document.location = 'uploadfile.php?type=tugas_akhir'; </script>";
                                }
                            ...
                            $row5 = mysqli_fetch_array($query5);
                            if($judul != $row5['judul']){
                                $sql1 = "UPDATE penelitian_dosen SET judul = '$judul', nama_anggota = '$nama_anggota',id_kategori_repo = '$kategori_repo',abstract = '$abstract' WHERE id = '{$_GET['id']}'";
                            }elseif($judul == $row5['judul'] && $row5['id'] == $_GET['id']){
                                $sql1 = "UPDATE penelitian_dosen SET judul = '$judul', nama_anggota = '$nama_anggota',id_kategori_repo = '$kategori_repo',abstract = '$abstract' WHERE id = '{$_GET['id']}'";
                            }else{
                                echo "<script> alert('Judul Sudah ada') </script>";
                            ...
                            $sql1 = "UPDATE ebook SET judul = '$judul',penulis = '$penulis',tgl_terbit = '$tgl_terbit',abstract = '$abstract' WHERE id = '{$_GET['id']}'";
                        }
                    }
                    ...
                    try{
                        ...
                        echo "<script type='text/javascript'> document.location = 'updatefile.php?type=$tipe&id={$_GET['id']}'; </script>";
                    }
        ...
        <div class="flex mb-20">
            ...
            <div class="w-full">
                <!-- Upload file -->
                <h4 class="font-bold border-b-2 border-gray-500 pb-4 mb-8">Update <?=$name?></h4>
                <?php
                    if($_GET['type'] == 'tugas_akhir'){
                        $sql5 = "SELECT * FROM tugas_akhir WHERE id = '{$_GET['id']}'";
                        $query5 = mysqli_query($con,$sql5);
                        $row5 = mysqli_fetch_array($query5);
                    }elseif($_GET['type'] == 'penelitian_dosen'){
                        $sql5 = "SELECT * FROM penelitian_dosen WHERE id = '{$_GET['id']}'";
                        $query5 = mysqli_query($con,$sql5);
                        $row5 = mysqli_fetch_array($query5);
                    }else{
                        $sql5 = "SELECT * FROM ebook WHERE id = '{$_GET['id']}'";
                        $query5 = mysqli_query($con,$sql5);
                        $row5 = mysqli_fetch_array($query5);
                    }
                ?>
                ...
                <div class="w-full flex">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <Textarea required class="w-full border-2 border-gray-400 rounded-md shadow-md focus:shadow-2xl p-2" cols="30" rows="6" name="judul" placeholder="Masukkan Judul"><?=$row5['judul']?></Textarea>
                    </div>
                </div>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <Textarea required class="w-full border-2 border-gray-400 rounded-md shadow-md focus:shadow-2xl p-2" cols="30" rows="6" name="abstract" placeholder="Masukkan Abstract"><?=$row5['abstract']?></Textarea>
                    </div>
                </div>
                        ...
                        <select class="max-w-fit h-10 my-4 rounded-md shadow-md px-4 bg-gray-200 focus:border-2 border-green-700 focus:outline-green-700 focus:bg-white" name="kategori_repo">
                            <?php 
                                while($row = mysqli_fetch_array($query)){
                                    ...
                                    if($row['id'] == $row5['id_kategori_repo']){
                            ?>
                                <option value="<?=$row['id']?>" selected><?=$row['nama_kategori']?> <?=$row7['nama_prodi']?></option>
                            <?php }else{ ?>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <input required class="max-w-fit h-10 my-4 rounded-md shadow-md px-4 bg-gray-200 focus:border-2 border-green-700 focus:outline-green-700 focus:bg-white" type="text" name="nim_mhs" value="<?=$row5['nim_mhs']?>">
                    </div>
                </div>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <input required class="max-w-fit h-10 my-4 rounded-md shadow-md px-4 bg-gray-200 focus:border-2 border-green-700 focus:outline-green-700 focus:bg-white" type="text" name="nip_doping1" value="<?=$row5['nip_dosen_pembimbing1']?>">
                    </div>
                </div>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <input required class="max-w-fit h-10 my-4 rounded-md shadow-md px-4 bg-gray-200 focus:border-2 border-green-700 focus:outline-green-700 focus:bg-white" type="text" name="nip_doping2" value="<?=$row5['nip_dosen_pembimbing2']?>">
                    </div>
                </div>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <input required class="max-w-fit h-10 my-4 rounded-md shadow-md px-4 bg-gray-200 focus:border-2 border-green-700 focus:outline-green-700 focus:bg-white" type="text" name="nip_dosen_penguji1" value="<?=$row5['nip_dosen_penguji1']?>">
                    </div>
                </div>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <input required class="max-w-fit h-10 my-4 rounded-md shadow-md px-4 bg-gray-200 focus:border-2 border-green-700 focus:outline-green-700 focus:bg-white" type="text" name="nip_dosen_penguji2" value="<?=$row5['nip_dosen_penguji2']?>">
                    </div>
                </div>
                        ...
                        <select class="max-w-fit h-10 my-4 rounded-md shadow-md px-4 bg-gray-200 focus:border-2 border-green-700 focus:outline-green-700 focus:bg-white" name="keyword">
                            <?php 
                                while($row1 = mysqli_fetch_array($query1)){
                                    if($row1['id'] == $row5['id_keyword']){
                            ?>
                                <option value="<?=$row1['id']?>" selected><?=$row1['nama_keyword']?></option>
                            <?php }else{ ?>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <input required class="max-w-fit h-10 my-4 rounded-md shadow-md px-4 bg-gray-200 focus:border-2 border-green-700 focus:outline-green-700 focus:bg-white" type="date" name="tgl_pengesahan" id="file" value="<?=$row5['tgl_pengesahan']?>">
                    </div>
                </div>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <Textarea required class="w-full border-2 border-gray-400 rounded-md shadow-md focus:shadow-2xl p-2" cols="30" rows="6" name="nama_anggota" placeholder="Masukkan Anggota"><?=$row5['nama_anggota']?></Textarea>
                    </div>
                </div>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <Textarea required class="w-full border-2 border-gray-400 rounded-md shadow-md focus:shadow-2xl p-2" cols="30" rows="6" name="penulis" placeholder="Masukkan Penulis"><?=$row5['penulis']?></Textarea>
                    </div>
                </div>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <input required type="date" name="tgl_terbit" value="<?=$row5['tgl_terbit']?>">    
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="w-full flex mt-4">
                    ...
                    <div class="w-3/4 px-4 py-2">
                        <input required class="" type="file" name="filename" id="file">
                    </div>
                </div>
