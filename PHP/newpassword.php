    ...
    <div class="w-full h-auto flex justify-center items-center md:px-24 md:py-12">
        <div class="w-full h-full flex justify-center items-center md:mx-auto">
            ...
            <div class="w-full lg:4/12 xl:w-5/12 h-full flex flex-col justify-evenly items-center py-4">
                <h1 class=" text-2xl lg:text-4xl">New Password</h1>
                ...
                <?php
                    if(isset($_POST['btnsave'])){
                        ...
                        if($pass == $cpass){
                            ...
                            $enpass = md5($pass);
                            $sql = "UPDATE akun SET kode_otp = $code, password = '{$enpass}' WHERE email = '{$email}'";
                            ...
                            if($query){
                                echo "<script> alert('Password berhasil diubah. Tekan OK untuk login') </script>";
                ...
                <div class="lg::w-4/6 h-full mt-8 flex flex-col justify-around items-center">
                    <div class="w-full h-28 flex flex-col justify-around">
                        <input class="w-full h-10 rounded-md shadow-md px-4 bg-gray-200 focus:outline-green-700 focus:bg-white" type="password" name="password" id="" placeholder="New Password">
                        <input class="w-full h-10 rounded-md shadow-md px-4 bg-gray-200 focus:outline-green-700 focus:bg-white" type="password" name="cpassword" id="" placeholder="Confirm New Password">
                    </div>
                    ...
                    <button class="w-full h-10 px-4 rounded-md shadow-md bg-[#006633] hover:bg-green-700 text-white" name="btnsave">Save</button>
                </div>
                </form>
            </div>
        </div>
